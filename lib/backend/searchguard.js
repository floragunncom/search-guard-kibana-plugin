...
export default class SearchGuardBackend {
    constructor(core, server, serverConfig, esConfig) {
        ...
        this._cluster = core.elasticsearch.createClient('searchguard', { plugins: [SearchGuardPlugin], auth: true });
    ...
    updateAndGetTenantPreferences(request, user, tenant) {
        const preferencesCookieName = this.serverConfig.get('searchguard.cookie.preferences_cookie_name');
