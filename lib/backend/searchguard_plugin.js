...
export default function (Client, config, components) {
    ...
    Client.prototype.searchguard.prototype.tenantinfo = ca({
        url: {
            fmt: '/_searchguard/tenantinfo'
        }
    });
    ...
    Client.prototype.searchguard.prototype.authtoken = ca({
        method: 'POST',
        needBody: true,
        url: {
            fmt: '/_searchguard/api/authtoken'
        }
    });

    Client.prototype.searchguard.prototype.permissions = ca({
        url: {
            fmt: '/_searchguard/permission'
        }
    });

    Client.prototype.searchguard.prototype.oidcwellknown = ca({
      url: {
        fmt: '/_searchguard/auth_domain/_first/openid/config'
      }
    });

    Client.prototype.searchguard.prototype.oidcauthtoken = ca({
        method: 'POST',
        needBody: true,
        url: {
          fmt: '/_searchguard/<%=tokenEndpoint%>',
          req: {
            tokenEndpoint: {
              type: 'string',
              required: true
