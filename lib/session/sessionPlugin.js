        ...
        request.auth.sgSessionStorage = {
            ...
            authenticateWithHeaders: async function (headers, credentials = {}, options = {}) {
                try {
                    ...
                    let sessionTTL = config.get('searchguard.session.ttl')
            ...
            _handleAuthResponse: function (credentials, authResponse, additionalAuthHeaders = {}) {
                ...
                if (settings.validateAvailableTenants && config.get("searchguard.multitenancy.enabled") && !config.get("searchguard.multitenancy.tenants.enable_global")) {
