...
module.exports = async function (
    ...
    server.route({
      ...
      handler: async (request, h) => {
        ...
        try {
          ...
          const { user } = await authInstance.authenticate(request, request.headers, {
          ...
          server.log(['searchguard', 'error'], `OpenID login ${error}`);
  ...
  server.route({
    ...
    handler: (request) => {
      ...
      // @todo This mus be changed to the new cookie
