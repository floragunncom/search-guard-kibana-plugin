...
describe(`${AuthClass.name} routes`, () => {
  describe('logoutHandler', () => {
    test('logout user', async () => {
      ...
      const sessionStorageFactoryGet = jest.fn().mockResolvedValue(expectedSessionCookie);
  ...
  describe('loginHandler', () => {
    ...
    describe('throw error', () => {
      ...
      beforeEach(() => {
        ...
        sessionStorageFactoryGet = jest.fn().mockResolvedValue(expectedSessionCookie);
