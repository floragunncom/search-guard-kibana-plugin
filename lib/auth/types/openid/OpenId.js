...
export default class OpenId extends AuthType {
  constructor(searchGuardBackend, server, APP_ROOT, API_ROOT, kibanaCore = null, config = null) {
    super(searchGuardBackend, server, APP_ROOT, API_ROOT, kibanaCore, (config = null));
