...
export default class OpenId extends AuthType {
    ...
    constructor(pluginRoot, server, kbnServer, APP_ROOT, API_ROOT, kibanaCore = null, config = null) {
        ...
        super(pluginRoot, server, kbnServer, APP_ROOT, API_ROOT, kibanaCore, config = null);
        ...
        try {
            ...
            // @todo Replace status. Or just log here, no?
    ...
    async setupRoutes() {
        try {
            ...
            require('./routes')(this.pluginRoot, this.server, this.kbnServer, this.APP_ROOT, this.API_ROOT, this.kibanaCore, this.config, endPoints);
