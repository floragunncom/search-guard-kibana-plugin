        ...
        handler: {
            async: async (request, reply) => {
                try {
                    ...
                    let {user} = await request.auth.sgSessionStorage.authenticate(request.payload);
                    ...
                    if (error instanceof AuthenticationError) {
                        ...
                        // This is handled as a normal 401 in the frontend right now
                        return reply(Boom.unauthorized('Missing Tenant'))
                    } else {
