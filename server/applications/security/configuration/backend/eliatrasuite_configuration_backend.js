 ...
 */
export default class EliatraSuiteConfigurationBackend {
  ...
  restapiinfo = async (headers) => {
    try {
      return await this._client({
        path: `${BACKEND_RESTAPI_BASEURL}/permissionsinfo`,
        method: 'get',
        headers: headers,
      });
    } catch (error) {
  ...
  list = async (headers, resourceName) => {
    try {
      return await this._client({
        path: `${BACKEND_RESTAPI_BASEURL}/${resourceName}`,
        method: 'get',
        headers,
      });
    } catch (error) {
  ...
  get = async (headers, resourceName, id) => {
    try {
      const response = await this._client({
        path: `${BACKEND_RESTAPI_BASEURL}/${resourceName}/${encodeURIComponent(id)}`,
        method: 'get',
        headers,
      });
  ...
  clearCache = async (headers) => {
    try {
      return await this._client({
        path: `${BACKEND_RESTAPI_BASEURL}/cache`,
        method: 'delete',
        headers,
      });
    } catch (error) {
