    ...
    return new kibana.Plugin({
        ...
        uiExports: {
            ...
            injectDefaultVars(server, options) {
                ...
                options.searchguard = {
                    rbac: {
                        enabled: exposedSettings.rbac.enabled
                    }
                }
        ...
        init(server, options) {
            ...
            // Not using RBAC for the SavedObjects yet
            if (0 && config.get('searchguard.rbac.enabled')) {
                ...
                this.status.green("Search Guard RBAC not enabled");
            }
