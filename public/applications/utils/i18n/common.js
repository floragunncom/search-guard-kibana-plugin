...
export const nameAlreadyExistsText = (
  <EuiI18n token="sg.common.nameAlreadyExists.text" default="Name already exists" />
);
export const mustBePositiveIntegerText = (
  <EuiI18n token="sg.common.mustBePositiveInteger.text" default="Must be positive integer" />
);
...
export const createText = (<EuiI18n token="sg.common.create.text" default="Create" />);
export const editText = (<EuiI18n token="sg.common.edit.text" default="Edit" />);
...
export const executeText = (<EuiI18n token="sg.common.execute.text" default="Execute" />);
export const activeText = (<EuiI18n token="sg.common.active.text" default="Active" />);
export const methodText = (<EuiI18n token="sg.common.method.text" default="Method" />);
export const throttlePeriodText = (<EuiI18n token="sg.common.throttlePeriod.text" default="Throttle Period" />);
