...
const inputExamples = {
      ...
      example: {
        query: {
          span_not: {
            ...
            exclude: {
              span_near: {
                clauses: [{ span_term: { field1: 'la' } }, { span_term: { field1: 'hoya' } }],
                slop: 0,
                in_order: true,
              },
            },
      ...
      example: {
        query: {
          span_containing: {
            ...
            big: {
              span_near: {
                clauses: [{ span_term: { field1: 'bar' } }, { span_term: { field1: 'baz' } }],
                slop: 5,
                in_order: true,
              },
            },
  ...
  [CHECKS.METRICS_AGGREGATIONS]: {
    avg: {
      ...
      link:
        'https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-metrics-avg-aggregation.html#search-aggregations-metrics-avg-aggregation',
    },
    weighted_avg: {
      example: {
        size: 0,
