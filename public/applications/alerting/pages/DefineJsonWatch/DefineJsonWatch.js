    ...
    if (!isReadOnly) {
      ...
      contentPanelActions.push(
        <EuiButton
          ...
          data-test-subj="spAlerting.jsonWatch.execute"
    ...
    return (
      <FormikCodeEditor
        ...
        rowProps={{
          ...
          labelAppend: (
            <LabelAppendLink
              name="spAlerting.jsonWatch.doc.getStarted"
      ...
      <EuiFormRow
        ...
        labelAppend={
          <EuiText size="xs" onClick={closeResponseEditor}>
            <EuiLink id="close-response" data-test-subj="spAlerting.jsonWatch.closeResponse">
              {closeText} X
            </EuiLink>
          </EuiText>
        }
