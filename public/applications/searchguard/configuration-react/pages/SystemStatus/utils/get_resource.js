  ...
  switch (selectSideNavItem) {
    ...
    default:
      return {
        ...
        HTTPBasicAuthenticator: pick(resources.modules.HTTP_BASIC_AUTHENTICATOR, [
          'version',
          'is_enterprise',
        ]),
        internalUsersAuthenticationBackend: pick(
          resources.modules.INTERNAL_USERS_AUTHENTICATION_BACKEND,
          ['version', 'is_enterprise']
        ),
        kibanaMultitenancy: pick(resources.modules.MULTITENANCY, ['version', 'is_enterprise']),
        RESTManagementAPI: pick(resources.modules.REST_MANAGEMENT_API, [
          'version',
          'is_enterprise',
        ]),
      };
