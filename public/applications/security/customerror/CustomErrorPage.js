        ...
        <EuiFlexItem grow={false}>
          <EuiPanel>
            <div style={{ margin: 'auto', maxWidth: '300px' }}>
              {showBrandImage && (
                <EuiImage
                  data-test-subj="sp.customError.brandImage"
                  alt="Brand image"
                  size="l"
                  url={
            ...
            <EuiText textAlign="center" data-test-subj="sp.customError.title">
              <h2>{title}</h2>
            </EuiText>
            <EuiText textAlign="center" data-test-subj="sp.customError.subTitle">
              <p>{subTitle}</p>
            </EuiText>
            <EuiFlexGroup justifyContent="spaceAround">
              <EuiFlexItem>
                <EuiButton
                  fill
                  href={buttonHref}
                  data-test-subj="sp.customError.btn"
                  id="sp.custom.home"
