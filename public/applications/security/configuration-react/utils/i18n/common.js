...
export const forbiddenCharsText = (
  <EuiI18n token="sp.common.forbiddenChars.text" default="Forbidden characters: . *" />
);

export const indicesPermissionsPrefixErrorText = (
  <EuiI18n
    token="sp.roles.inicesPermissionsPrefixError.text"
...
export const clusterPermissionsPrefixErrorText = (
  <EuiI18n
    token="sp.roles.clusterPermissionsPrefixError.text"
...
export const permissionsPrefixErrorText = (
  <EuiI18n
    token="sp.roles.permissionsPrefixError.text"
