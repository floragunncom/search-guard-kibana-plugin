...
describe('role to UI role ', () => {
  ...
  test('can build UI action groups', () => {
    const resource = {
      ...
      f: { type: 'kibana' },
      g: { type: 'kibana' },
      ALERTING_ACCOUNT_READ: { type: 'alerting' },
      ALERTING_ACCOUNT_MANAGE: { type: 'alerting' },
      ALERTING_WATCH_READ: { type: 'alerting' },
      ALERTING_WATCH_MANAGE: { type: 'alerting' },
      ALERTING_WATCH_EXECUTE: { type: 'alerting' },
      ALERTING_WATCH_ACTIVATE: { type: 'alerting' },
      ALERTING_WATCH_ACKNOWLEDGE: { type: 'alerting' },
      // We omit the following action group
      // because it will be deprecated soon.
      ALERTING_ALL: { type: 'alerting' },
    };

    const uiResource = {
      allClusterActionGroups: [
        { label: 'ALERTING_ACCOUNT_MANAGE' },
        { label: 'ALERTING_ACCOUNT_READ' },
        { label: 'a' },
        { label: 'b' },
        { label: 'e' },
      ],
      ...
      allTenantActionGroups: [
        { label: 'ALERTING_WATCH_ACKNOWLEDGE' },
        { label: 'ALERTING_WATCH_ACTIVATE' },
        { label: 'ALERTING_WATCH_EXECUTE' },
        { label: 'ALERTING_WATCH_MANAGE' },
        { label: 'ALERTING_WATCH_READ' },
        { label: 'f' },
        { label: 'g' },
      ],
    };
