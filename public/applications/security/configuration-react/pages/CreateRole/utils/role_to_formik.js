...
export function actionGroupsToUiClusterIndexTenantActionGroups(actionGroups = {}) {
  ...
  function handleAlertingActionGroups(actionGroupName) {
    switch (actionGroupName) {
      case 'ALERTING_ACCOUNT_READ':
      case 'ALERTING_ACCOUNT_MANAGE':
        allClusterActionGroups.push({ label: actionGroupName });
        break;
      case 'ALERTING_WATCH_READ':
      case 'ALERTING_WATCH_MANAGE':
      case 'ALERTING_WATCH_EXECUTE':
      case 'ALERTING_WATCH_ACTIVATE':
      case 'ALERTING_WATCH_ACKNOWLEDGE':
    ...
    .forEach((label) => {
      switch (actionGroups[label].type) {
        ...
        case 'all':
          ...
          break;
        case 'alerting':
          handleAlertingActionGroups(label);
          break;
        default:
          break;
      }
