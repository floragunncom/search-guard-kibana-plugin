...
app.controller('sgTenantsController', function ($scope, $element, $route, createNotifier, backendTenants, kbnUrl) {
...
app.controller('sgEditTenantsController', function ($scope, $element, $route, $location, $routeParams, createNotifier, backendTenants, backendAPI, kbnUrl) {
