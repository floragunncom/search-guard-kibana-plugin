...
export const i18nBackendRolesText = (<EuiI18n token="sgBackendRoles.text" default="Backend Roles" />);
export const i18nUserAttributesText = (<EuiI18n token="sgUserAttributes.text" default="User Attributes" />);
