...
export const usernameMustNotContainDotsAndAsterisksText = (
  <EuiI18n token="sg.internalUsers.usernameMustNotContainDotsAndAsterisks.text" default="Username must not contain '.' or '*'" />
);
