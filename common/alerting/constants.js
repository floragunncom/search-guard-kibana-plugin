...
export const APP_NAME = 'eliatra-suite-alerting';
export const APP_DESCRIPTION = 'Alerting';

export const INDEX = {
  ALERTS: '..alerting_plus_log_*',
  ALERT_DOC_TYPE: '_doc',
};
...
export const ROUTE_PATH = {
  ...
  SECURITY: {
    ALERTING_HAS_PERMISSIONS: `${BASE_URI}/security/alerting_has_permissions`,
  },
};


export const ALERTING_BACKEND_BASEURL = "/_eliatra/alerting"
...
export const PERMISSIONS_FOR_ACCESS = ['cluster:admin:eliatrasuite:tenant:alerting:watch/get'];
